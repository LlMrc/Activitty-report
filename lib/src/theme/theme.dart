...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff7b4e80),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xffffd6ff),
      onTertiaryContainer: Color(0xff300938),
      ...
      onTertiaryFixed: Color(0xff300938),
      tertiaryFixedDim: Color(0xffeab5ee),
      onTertiaryFixedVariant: Color(0xff613767),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff5c3363),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff936498),
      ...
      tertiaryFixed: Color(0xff936498),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff784c7d),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff38113f),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff5c3363),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff5c3363),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff441d4b),
      onTertiaryFixedVariant: Color(0xffffffff),
      surfaceDim: Color(0xffd8dbd2),
      surfaceBright: Color(0xfff7fbf1),
      surfaceContainerLowest: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffeab5ee),
      onTertiary: Color(0xff48204f),
      tertiaryContainer: Color(0xff613767),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffefb9f2),
      onTertiary: Color(0xff2a0433),
      tertiaryContainer: Color(0xffb180b5),
      ...
      tertiaryFixed: Color(0xffffd6ff),
      onTertiaryFixed: Color(0xff24002d),
      tertiaryFixedDim: Color(0xffeab5ee),
      onTertiaryFixedVariant: Color(0xff4e2655),
      surfaceDim: Color(0xff10140f),
      surfaceBright: Color(0xff363a34),
      surfaceContainerLowest: Color(0xff0b0f0a),
      surfaceContainerLow: Color(0xff191d17),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffefb9f2),
      onTertiaryContainer: Color(0xff000000),
      ...
      tertiaryFixedDim: Color(0xffefb9f2),
      onTertiaryFixedVariant: Color(0xff2a0433),
      surfaceDim: Color(0xff10140f),
      surfaceBright: Color(0xff363a34),
      surfaceContainerLowest: Color(0xff0b0f0a),
      surfaceContainerLow: Color(0xff191d17),
